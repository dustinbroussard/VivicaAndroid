...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      ...
      <nav class="mdl-navigation mdl-layout--large-screen-only">Check performed at Mon Sep 08 17:13:24 CDT 2025 by AGP (8.7.2)</nav>
    </div>
  </header>
...
<span class="location"><a href="../../src/main/java/com/capacitorjs/plugins/statusbar/StatusBarPlugin.java">../../src/main/java/com/capacitorjs/plugins/statusbar/StatusBarPlugin.java</a>:40</span>: <span class="message">Implicitly using the default locale is a common source of bugs: Use <code>toLowerCase(Locale)</code> instead. For strings meant to be internal use <code>Locale.ROOT</code>, otherwise <code>Locale.getDefault()</code>.</span><br /><pre class="errorlines">
<span class="lineno">  37 </span>    }
<span class="lineno">  38 </span>
<span class="lineno">  39 </span>    <span class="keyword">private</span> String styleFromConfig(String style) {
<span class="caretline"><span class="lineno">  40 </span>        <span class="keyword">switch</span> (style.<span class="warning">toLowerCase</span>()) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  41 </span>            <span class="keyword">case</span> <span class="string">"lightcontent"</span>:
<span class="lineno">  42 </span>            <span class="keyword">case</span> <span class="string">"dark"</span>:
<span class="lineno">  43 </span>                <span class="keyword">return</span> <span class="string">"DARK"</span>;
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:19</span>: <span class="message">A newer version of com.android.tools.build:gradle than 8.7.2 is available: 8.13.0. (There is also a newer version of 8.7.&#55349;&#56421; available, if upgrading to 8.13.0 is difficult: 8.7.3)</span><br /><pre class="errorlines">
<span class="lineno"> 16 </span>        }
<span class="lineno"> 17 </span>    }
<span class="lineno"> 18 </span>    dependencies {
<span class="caretline"><span class="lineno"> 19 </span>        classpath <span class="warning"><span class="string">'com.android.tools.build:gradle:8.7.2'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:76</span>: <span class="message">A newer version of androidx.core:core than 1.15.0 is available: 1.17.0</span><br /><pre class="errorlines">
<span class="lineno"> 73 </span>        implementation project(<span class="string">':capacitor-android'</span>)
<span class="lineno"> 74 </span>    }
<span class="lineno"> 75 </span>
<span class="caretline"><span class="lineno"> 76 </span>    implementation <span class="warning"><span class="string">"androidx.core:core:$androidxCoreVersion"</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 77 </span>    implementation <span class="string">"androidx.appcompat:appcompat:$androidxAppCompatVersion"</span>
<span class="lineno"> 78 </span>    testImplementation <span class="string">"junit:junit:$junitVersion"</span>
<span class="lineno"> 79 </span>    androidTestImplementation <span class="string">"androidx.test.ext:junit:$androidxJunitVersion"</span></pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:77</span>: <span class="message">A newer version of androidx.appcompat:appcompat than 1.7.0 is available: 1.7.1</span><br /><pre class="errorlines">
<span class="lineno"> 74 </span>  }
<span class="lineno"> 75 </span>
<span class="lineno"> 76 </span>  implementation <span class="string">"androidx.core:core:$androidxCoreVersion"</span>
<span class="caretline"><span class="lineno"> 77 </span>  implementation <span class="warning"><span class="string">"androidx.appcompat:appcompat:$androidxAppCompatVersion"</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 78 </span>  testImplementation <span class="string">"junit:junit:$junitVersion"</span>
