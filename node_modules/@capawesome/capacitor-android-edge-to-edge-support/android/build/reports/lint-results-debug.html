...
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:14</span>: <span class="message">A newer version of com.android.tools.build:gradle than 8.7.2 is available: 8.12.0. (There is also a newer version of 8.7.&#55349;&#56421; available, if upgrading to 8.12.0 is difficult: 8.7.3)</span><br /><pre class="errorlines">
<span class="lineno"> 11 </span>        mavenCentral()
<span class="lineno"> 12 </span>    }
<span class="lineno"> 13 </span>    dependencies {
<span class="caretline"><span class="lineno"> 14 </span>        classpath <span class="warning"><span class="string">'com.android.tools.build:gradle:8.7.2'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:54</span>: <span class="message">A newer version of androidx.appcompat:appcompat than 1.7.0 is available: 1.7.1</span><br /><pre class="errorlines">
<span class="lineno"> 51 </span>dependencies {
<span class="lineno"> 52 </span>    implementation fileTree(dir: <span class="string">'libs'</span>, include: [<span class="string">'*.jar'</span>])
<span class="lineno"> 53 </span>    implementation project(<span class="string">':capacitor-android'</span>)
<span class="caretline"><span class="lineno"> 54 </span>    implementation <span class="warning"><span class="string">"androidx.appcompat:appcompat:$androidxAppCompatVersion"</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 55 </span>    testImplementation <span class="string">"junit:junit:$junitVersion"</span>
<span class="lineno"> 56 </span>    androidTestImplementation <span class="string">"androidx.test.ext:junit:$androidxJunitVersion"</span>
<span class="lineno"> 57 </span>    androidTestImplementation <span class="string">"androidx.test.espresso:espresso-core:$androidxEspressoCoreVersion"</span></pre>
